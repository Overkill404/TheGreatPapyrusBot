...
def build_summon_portal_embed(guild, summoner_name, boss):
    """Public summon portal - short and readable. Universe Finals get a premium look."""
    ...
    if is_uf:
        embed = discord.Embed(
            ...
            description=(
                ...
                f"```\n"
                f"╔══════════════════════════════════════╗\n"
                f"║   A P E X   O F   T H E   U N I V   ║\n"
                f"║      beyond final · beyond hope     ║\n"
                f"╚══════════════════════════════════════╝\n"
                f"```\n"
                f"*{summoner_name} tore open a **Universe Apex** seal.*\n\n"
                f"▸ {stats}\n\n"
        ...
        embed.set_footer(text="✦✦ Universe Apex · beyond Final · 120s · first enter claims ✦✦")
    elif is_final:
        embed = discord.Embed(
